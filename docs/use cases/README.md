...
- ID: v1.ORGANIZATION.004
  ...
  @startuml
      ...
      |Користувач|
          ...
          запиту даними: назва опитування,
          питання, варіанти відповіді або
          текстові поля для вписання відповіді,
...
- ID: v1.ORGANIZATION.005
  ...
  @startuml
      ...
      |Користувач|
          :Користувач заповнює форму
          запиту даними: додані, видалені
          або змінені запитання або відповіді, 
          змінені налаштування опитування;
